...
namespace FriendBook.GroupService.API.BLL.Interfaces
{
    ...
    {
        public Task<BaseResponse<StageGroupTaskIconDTO>> Create(RequestStageGroupTasNew requestStageGroupTasNew, Guid adminId, Guid groupId);
        ...
        public Task<BaseResponse<List<StageGroupTaskIconDTO>>> GetStagesGroupTaskIconByGroupId(Guid groupid, Guid userId);
